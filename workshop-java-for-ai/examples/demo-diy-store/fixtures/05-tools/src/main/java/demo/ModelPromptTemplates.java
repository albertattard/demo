...
public class ModelPromptTemplates {
    ...
    private final Resource toolProductSelectionSystemPrompt;
    ...
    public ModelPromptTemplates(
            ...
            @Value("classpath:prompts/tool-product-selection-system.st") final Resource toolProductSelectionSystemPrompt) {
        ...
        this.toolProductSelectionSystemPrompt = toolProductSelectionSystemPrompt;
    }
    ...
    public Resource toolProductSelectionSystemPrompt() {
        return toolProductSelectionSystemPrompt;
    }
}

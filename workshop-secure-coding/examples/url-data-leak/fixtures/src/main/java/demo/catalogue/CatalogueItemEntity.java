...
public class CatalogueItemEntity implements Serializable {
    ...
    public CatalogueItemEntity(final UUID guid, final String caption, final String description) {
        this.guid = guid;
        this.caption = caption;
        this.description = description;
    }

    public CatalogueItemEntity(final long id, final UUID guid, final String caption, final String description) {
        this.id = id;
        this.guid = guid;
        this.caption = caption;
        this.description = description;
    ...
    public String toString() {
        return "CatalogueItemEntity[id=%d, guid=%s, caption=%s, description=%s]".formatted(id, guid, caption, description);
    }
}

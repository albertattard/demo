...
```shell
% mvn clean package
% java -cp ./target/mysql-encryption-1.0-SNAPSHOT.jar com.oracle.jsc.encrypt.BuildDB
```
...
% java -cp ./target/mysql-encryption-1.0-SNAPSHOT.jar com.oracle.jsc.encrypt.Crypto

# Encrypt some data
% java -cp ./target/mysql-encryption-1.0-SNAPSHOT.jar com.oracle.jsc.encrypt.EncryptKeyData
...
```shell
% java -cp ./target/mysql-encryption-1.0-SNAPSHOT.jar com.oracle.jsc.encrypt.DecryptKeyData
```
...
```shell
% java -cp ./target/mysql-encryption-1.0-SNAPSHOT.jar com.oracle.jsc.encrypt.UnbuildDb
```
...
client-certs example. You can also
